...
namespace Gatherum.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260830024809_AuthenticatedAccess")]
    partial class AuthenticatedAccess
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gatherum.Core.Domain.Node", b =>
                {
                    ...
                    b.Property<bool>("ListedToSignedIn")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Gatherum.Core.Domain.ReadingPosition", b =>
                {
                    b.Property<Guid>("NodeId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Gatherum.Core.Domain.NodeCategory", b =>
                {
                    b.HasOne("Gatherum.Core.Domain.Node", "Category")
                        .WithMany("Members")
